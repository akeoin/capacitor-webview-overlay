...
export interface IWebviewOverlayPlugin {
    ...
    addListener(eventName: 'pageLoaded' | 'updateSnapshot' | 'progress' | 'navigationHandler' | 'miniAppCallback' | 'historyChanged', listenerFunc: (...args: any[]) => void): PluginListenerHandle;
}
